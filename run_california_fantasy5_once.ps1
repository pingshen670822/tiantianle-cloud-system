...
if ($All) {
  ...
  $env:TIANTIANLE_FORMULA_BACKTEST_ROUNDS = "120"
  $env:TIANTIANLE_PACK_GOVERNANCE_ROUNDS = "60"
  $env:TIANTIANLE_PRECISION_TOURNAMENT_ROUNDS = "120"
  ...
  $env:TIANTIANLE_CORE_BACKTEST_ROUNDS = "30"
  $env:TIANTIANLE_INDUSTRIAL_BACKTEST_ROUNDS = "30"
  $env:TIANTIANLE_ADVANCED_BACKTEST_ROUNDS = "30"
  $env:TIANTIANLE_UNLIKELY_BACKTEST_ROUNDS = "30"
  $env:TIANTIANLE_FORMULA_BACKTEST_ROUNDS = "30"
  $env:TIANTIANLE_PACK_GOVERNANCE_ROUNDS = "30"
  $env:TIANTIANLE_PRECISION_TOURNAMENT_ROUNDS = "30"
  $env:TIANTIANLE_GROUP_BACKTEST_SHORT = "30"
  $env:TIANTIANLE_GROUP_BACKTEST_MID = "30"
  $env:TIANTIANLE_GROUP_BACKTEST_LONG = "30"
  $env:TIANTIANLE_RUN_MODE = "realtime"
}
