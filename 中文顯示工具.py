...
TEXT_REPLACEMENTS = [
    ...
    ("industrial_fast_daily_full_history_v20260630_strict_no_reuse", "每日全歷史快速重算加防沿用守門版"),
    ("fast_daily_precision_micro_v20260629", "每日快速短包精算版"),
    ("daily fast full-history recompute; deep tournament deferred", "每日全歷史快速重算；深度競賽延後背景檢查"),
    ("fast_daily_recomputed_pending_deep_gate", "每日快速重算完成，等待深度守門"),
    ("verified_research_complete", "研究驗證完成"),
    ("fast_daily_publish_then_deep_review", "每日快速發布後深度複核"),
    ("fast_daily_recomputed", "每日快速重算完成"),
    ("deferred_fast_daily", "每日快速版暫緩深度檢查"),
    ("strict_no_previous_reuse_enforced", "防沿用守門已啟用"),
    ("strict_no_previous_reuse", "禁止沿用上期"),
    ("strict_reentry_gate_enforced", "連莊達標守門"),
    ("latest_repeat_soft_guard", "最新開出號軟守門"),
    ("soft_penalty_previous_top15_with_recovery_revalidation", "上期前十五軟降權並重新驗證"),
    ("soft_penalty_上期前十五_with_recovery_revalidation", "上期前十五軟降權並重新驗證"),
    ("pre_no_reuse_governor", "防沿用守門前置檢查"),
    ("high_confidence_watch", "高信心觀察"),
    ("recomputed_updated_watch_only_pending", "已重算待觀察"),
    ("precision_single", "精算獨隻"),
    ("precision_two_hit_one", "精算二中一"),
    ("precision_three_hit_one", "精算三中一"),
    ("precision_watch", "精算觀察"),
    ("perfect_日期特徵_card", "完美日期牌"),
    ("perfect_drag_card", "完美必拖牌"),
    ("perfect_date_card", "完美日期牌"),
    ("perfect_drag", "完美必拖牌"),
    ("precision_二中一", "精算二中一"),
    ("precision_觀察", "精算觀察"),
    ("usable_觀察", "可觀察"),
    ("official_release_allowed", "正式發布允許"),
    ("critical", "嚴重警戒"),
    ("complete", "完整"),
    ("models", "模型集合"),
    ...
    ("score", "分數"),
    ("confidence", "信心"),
    ("cross_validation_passed", "交叉驗算通過數"),
    ("stability_count", "穩定層數"),
    ("previous_top15", "上期前十五"),
    ("previous_top9", "上期前九"),
    ("previous_top5", "上期前五"),
    ("previous_single", "上期獨隻"),
    ("latest_draw_number", "最新開出號"),
    ("model_probability_percent", "模型機率"),
    ("original_score_before_no_reuse", "防沿用前原始分數"),
    ("no_reuse_penalty", "防沿用降權"),
